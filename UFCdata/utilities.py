...
def update_fighters(fighter: str, colour: str, fighters_dict: dict, fighter_soup: BeautifulSoup, isTitle: bool, conclusion: str) -> dict:
    ...
    fighters_dict.get(fighter)["Average Significant Strikes in Clinch % Landed"] = (temp_clinch_landed * no_of_fights) / (temp_clinch_attempted * no_of_fights) if temp_clinch_attempted > 0 and no_of_fights > 0 else 0 
